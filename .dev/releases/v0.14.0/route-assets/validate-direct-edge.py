#!/usr/bin/env python3
"""Validate one evidence-bound direct route into the v0.14.0 package.
...
EXPECTED_ARCHIVE_SHA256 = "6f332f2a17549eb46109d1b2786cdefb32839eea18520cd65476c246d1337116"
EXPECTED_PACKAGE_ID = "ai-context-dotnet-backend-v0.14.0"
EXPECTED_SOURCE_COMMIT = "60572c01e31abf58191d38adb5ca39e05338b08d"
EXPECTED_TARGET_VERSION = "v0.14.0"
...
ORIGIN_SPECS = {
    "v0.6.0": {
        "commit": "8b98b5f917513f2d143f42a322050a1162bb63f9",
        "manifest_sha256": "20ca69ef4e1b4085476a2b15eeba93da7a75ea580fd2ab9f6c8815938b0af3be",
    },
    "v0.9.0": {
        "commit": "c14a3260cba7d0a9e2b67b73df9e221280d2d2ef",
        "manifest_sha256": "c293247612eb2f01ef42e4d7c55be4ff36201cdf034157c518de871ec2acb5c7",
    },
    "v0.13.0": {
        "commit": "8584337b47295da1af914180baf2b3f815b9dcc7",
        "manifest_sha256": "850b74f5f23825f42912ac401a52692bc4cf02627fd9f8a452753f41611fbce4",
    },
}
...
def validate_edge(args: argparse.Namespace) -> dict[str, str]:
    ...
    if archive_sha256 != EXPECTED_ARCHIVE_SHA256:
        raise ValidationError("archive does not match the exact validated v0.14 ZIP")
    ...
    if (
        ...
        raise ValidationError("internal package version or source identity does not match v0.14")
    if not all(
