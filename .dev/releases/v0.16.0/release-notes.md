...
- Direct upgrade support from v0.6.0, v0.9.0 and v0.15.1, with source-specific reconciliation and durable recovery.
- A diagnostic analyst route for causal investigation before repair.
- Content-based validation evidence reuse and observed dependency checks, while current admission checks remain fresh.
- Exact package archive promotion and public asset verification.
