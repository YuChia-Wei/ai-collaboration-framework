...
Version-specific v0.17.0 executor. The v0.16.0 executor remains unchanged so
...
ORIGINS = {
    ...
    "v0.16.0": ("d136b69e4153e7c85f892871fb0d3e6c5d8f88c7fd89d43fdb1b03ca88c5c85d", "41fc410bde7a2745bed1663eb28d89ce5a5e6672b15fa95db82e7089c2972ab4"),
}
EVIDENCE = ".dev/decisions/direct-v017-fixture.md"
...
if (root/'.git/fail-target-validation').exists():
    raise SystemExit(17)
expected=json.loads((root/'.dev/validation/expected-v017.json').read_bytes())
...
def seed_target(previous, incoming, target, customized, apply, provenance, rules, logs):
    ...
    write_json(target / ".dev/validation/expected-v017.json", {"managed": managed, "preserved": preserved, "removed": removed})
...
def execute_case(origin, previous, incoming, output, customized, recovery, apply, provenance, rules):
    ...
    candidate["last_migration"] = {"status": "completed", "from_version": origin, "to_version": "v0.17.0", "completed_at": stamp(), "evidence": EVIDENCE}
    candidate_ledger = deepcopy(ledger)
    for entry in candidate_ledger["customizations"]:
        entry["incoming"] = {"version": "v0.17.0", "status": "absent", "evidence": EVIDENCE}
