...
- Active: COST-001.
- Next: Candidate 04 is built and archive-validated from `4f057c2c79a5b2351515db0cc6e65a2e5112ab42`. The owner approved one receipt/audit retry on 2026-09-18 and requested the now-open lab draft PR #13. Complete correct-authority adoption in the short trial checkout and matched candidate reviews; refresh the package after the Windows path guidance before final matrix execution.
