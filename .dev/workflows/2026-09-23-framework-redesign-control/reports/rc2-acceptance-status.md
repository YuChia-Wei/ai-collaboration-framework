...
| --- | --- |
| R1 source self-adoption | Selected for rc.2; pending actual source use. |
| R2 new-format publication/delivery | Catalog/delivery implementation is within rc.2 work; a candidate does not complete hosted publication. New tag/Release remains unselected. |
