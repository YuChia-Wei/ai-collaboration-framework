#!/usr/bin/env python3
"""Validate the evidence-bound direct route from v0.15.0 into v0.15.1.
...
EXPECTED_ARCHIVE_SHA256 = "cbabde70a921eba8c59255fc2f414961c9aaab0151b08d27956071f8f1c066ca"
EXPECTED_PACKAGE_ID = "ai-collaboration-framework-v0.15.1"
EXPECTED_SOURCE_COMMIT = "f2b5fa7c13550efaeb65ab9fcaeb0403baa2a5af"
...
ORIGIN_SPECS = {
    "v0.15.0": {
        "commit": "5fedaceef7e18b4cdcde3cb665adcc97070db2df",
        "manifest_sha256": "516601a76f8d4100f8e26703288e8aba45dbea5f9b065d8d9ac3a5342586a0fc",
    },
}
...
def validate_edge(args: argparse.Namespace) -> dict[str, Any]:
    if args.cutover_id != EXPECTED_CUTOVER_ID:
        raise ValidationError("requested semantic cutover is not the v0.15 package cutover")
    ...
    if archive_sha256 != EXPECTED_ARCHIVE_SHA256:
        raise ValidationError("archive does not match the exact v0.15.1 release candidate ZIP")
    ...
    if (
        ...
        raise ValidationError("internal package version or source identity does not match v0.15.1")
    if not all(
    ...
    parse_files_manifest(
        ...
        f"ai-collaboration-framework-{origin}",
    )
