...
The lifecycle validator first could not launch its registry reader inside the default sandbox; authorized native execution then detected unsorted classification IDs. Sorting the new entry resolved the failure, and the lifecycle contract passed.
