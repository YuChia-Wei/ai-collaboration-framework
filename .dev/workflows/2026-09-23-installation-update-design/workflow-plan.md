# Issue #345 design workflow

Owning skill ai-context-governance. Authority: [U001](../../standards/FRAMEWORK-REDESIGN-EXECUTION-OVERRIDE.md), [scope](../2026-09-23-framework-redesign-control/reports/p6-installation-design-scope.md), [Issue #345](https://github.com/YuChia-Wei/ai-collaboration-framework/issues/345). Base `758a7f51c745ee61625cc089b593367fd1a45533`; subsequent P5 input `842b73ca09d701d1561109255193d80439dc996b` read without merging.

One substantive task INSTALL-DESIGN-001 preserves source-bound design/authority and durable cross-session handoff. No padding tasks/audits. Existing templates adapted under U001; completion is design only, not implementation/activation/verification.

Identity: F:/framework-next/345, branch codex/2026-09-23-installation-update-design; persistent common Git directory C:/Github/YuChia/ai-collaboration-prompts-dotnet-backend/.git. Required/user-declared gpt-6-astra / ultra; not independent runtime attestation. No sub-agents/conversations created. Only assigned design/workflow roots writable.

| Acceptance | Observable criterion | Result location |
| --- | --- | --- |
...
| A345-07 | Four overlapping Issues remain separate | Source evidence; all read OPEN, none fulfilled by inference. |

Actual pre-edit: initial Git identity/empty porcelain matched; live five-Issue reads succeeded after initial proxy refusal; graph lacked current scoped coverage, explicit Git/source/AST fallback; seven distribution modules ast.parse and manifest/profile YAML declaration extraction only. A first oversized document-write command failed before process creation with Windows error 206; bounded smaller writes succeeded. This is authoring environment evidence, not a product path test.
