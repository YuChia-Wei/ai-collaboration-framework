...
Use merge-commit topology for the coupled migration contracts, exact archive admission and retained execution evidence, preserving preparation commits as provenance. The current implementation checkpoint is UPG006-contract. No implementation acceptance is established yet. Next: update prospective horizon policy and direct route admission; then validate actual target behavior before freezing admitted assets.
