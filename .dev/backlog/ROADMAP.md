...
- `updated_at`: `2026-07-28T21:31:43+08:00`
...
v0.7.0 is published and no successor release is automatically active. Hold an
owner roadmap discussion before assigning a new `current_target`. Keep
`DEVWF-001`, `INIT-001`, `STD-001`, and `OBS-001` independently gated unless an
explicit decision assigns them. Do not silently include provider adoption, a
future software-delivery orchestrator, historical archive migration, or legacy
identifier retirement in a successor release.
