...
- `v0.7.0`: `GOV-003` records the completed AI execution provenance policy's common
  ...
  package publication until the policy is proven portable or excluded as
  source-local. Historical archive migration and legacy identifier retirement
  remain conditional and require separately approved successor work.
...
`DEVWF-001`, `INIT-001`, `STD-001`, and `OBS-001` independently gated unless
an explicit decision assigns them. Do not silently include a future
