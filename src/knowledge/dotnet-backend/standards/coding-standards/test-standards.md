...
`.feature` files and runners are not minimum dependencies. When requirements directly provide a `.feature` file, its design or production is explicitly requested, or the target profile has adopted a runner, create or maintain it according to the [Gherkin Feature Storage Guide](../../guides/GHERKIN-FEATURE-STORAGE-GUIDE.MD). Otherwise, express the scenario directly as a GWT-style C# test.
...
Use the [GWT handoff contract](../../../engineering-common/references/GWT-TEST-HANDOFF-CONTRACT.md)
...
| Example | Path |
|------|------|
| Reqnroll/Gherkin reference | [../../examples/bdd-gherkin-example/](../../examples/bdd-gherkin-example/README.md) |
| BDD Given-When-Then | [../../examples/bdd-given-when-then-example/](../../examples/bdd-given-when-then-example/README.md) |
...
- [../../guides/FRAMEWORK-API-INTEGRATION-GUIDE.md](../../guides/FRAMEWORK-API-INTEGRATION-GUIDE.md)
