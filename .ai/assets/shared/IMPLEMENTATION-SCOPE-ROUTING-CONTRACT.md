...
| Several independent behavior goals or an unbounded cross-module request | `software-development-orchestrator` | Bound and sequence the work before implementing it as if it were one slice. |
