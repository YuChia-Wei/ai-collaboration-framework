...
class PythonSourceEntrypointTests(unittest.TestCase):
    ...
    def test_gwt_001_given_source_only_registry_when_help_is_requested_then_all_sixteen_direct_clis_remain_callable(self) -> None:
        self.assertEqual(16, len(self.source_only))
    ...
    def test_gwt_002_given_shadowed_yaml_when_source_only_pyyaml_clis_run_then_each_blocks_before_target_body_or_writes(self) -> None:
        self.assertEqual(15, len(self.pyyaml_source_only))
