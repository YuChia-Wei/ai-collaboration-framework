...
def main() -> int:
    ...
    environment_routes = validate_environment_execution_routing(errors, root=ROOT)
    lesson_count = 0
    ...
    print(
        ...
        f"{environment_routes} local environment routes, and {lesson_count} governed lessons."
    )
    print(
